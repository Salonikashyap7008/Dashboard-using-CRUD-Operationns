...
if (request.getParameter("submit")!= null) {
    ...
    String username = request.getParameter("username");
     Part imagePart = request.getPart("image");
        ...
        pst = con.prepareStatement("update uploading set stname=?, username=?,image=?,pdf=? where id = ?");
...
<%
           ...
           con = DriverManager.getConnection("jdbc:mysql://localhost:3306/rkinfosystems", "root", "Saloni@2002");
            String id = request.getParameter("id");
            pst = con.prepareStatement("select * from uploading where id = ?");
 ...
 %> 
           ...
           <input type="text" placeholder="name" name="sname" value="<%=rs.getString("stname")%>" id="sname" required>
            ...
            <input  type="file"  name="image"  value="<%=rs.getString("image")%>" id="image" required>
            
            <input type="file"  name="pdf" value="<%=rs.getString("pdf")%>" id="pdf" required>
           ...
           <a href="uploadingfetchdata.jsp">Back</a>
